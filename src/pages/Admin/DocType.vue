              ...
              <q-card style="width: 800px; max-width: 100vw" class="q-pa-sm">
                ...
                <q-card-section class="q-gutter-md row">
                  <div class="col">
                    <q-input
                            outlined
                            v-model="presentDoctype.category"
                            label="Category"
                          />                 
                   </div>
                </q-card-section>
                ...
                <q-card-actions align="right">
                  ...
                  <q-btn flat label="Save" color="primary" @click="onSaveDoctype" v-close-popup />
                </q-card-actions>
              </q-card>
            </q-dialog>
              ...
              <q-card style="width: 300px">
                <q-card-section class="row items-center">
                  <q-avatar
                    ...
                    text-color="white"
                  />
                  <span class="q-ml-sm">Confirm Delete {{presentDoctype.category}}?</span>
                </q-card-section>
                <q-card-actions align="right">
                  <q-btn
                    flat
